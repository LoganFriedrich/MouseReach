...
Successor to generate_fpfn_review_manifests_v8_0_2.py. Differences from v8.0.2:

- Algo source: v8.0.1 outputs WITH v8.0.2 trim AND v8.0.3 apex-split
  applied inline (both are postprocesses computed from DLC).
- Matcher: asymmetric strict tolerance (start_delta in [-2, +5]).
- Output: fpfn_review_manifests/v8.0.3/  (parallel to v8.0.2/)
- Archive: existing v8.0.2/ manifest dir is archived alongside v8.0.3/
  (the v8.0.2 dir is the "prior" manifest population this regen supersedes).
- v8.0.3 apex-split parameters (defaults, calibrated 2026-05-22):
  prominence=0.12, depth_min=0.5, peak2_rel_max=0.85, min_distance=4,
  min_span=3.
